...
public function store(Request $request)
{
    $request->validate([
        ...
        'items.*.product_variant_id' => 'sometimes|nullable|exists:product_variants,id', // Allow null for product_variant_id
    ...
    foreach ($request->items as $item) {
        OrderItem::create([
            ...
            'product_variant_id' => $item['product_variant_id'] ?? null, // Allow null for product_variant_id
            'quantity' => $item['quantity'],
            'price' => $item['price'],
            'image' => $item['image'] ?? null, // Allow null for image if not provided
        ]);
    }
